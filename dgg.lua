...
local Colors_Table = {
main_background = Color3.fromRGB(12, 14, 12),
sidebar_background = Color3.fromRGB(16, 18, 16),
section_background = Color3.fromRGB(20, 22, 20),
element_background = Color3.fromRGB(26, 28, 26),
element_hover_background = Color3.fromRGB(32, 35, 32),
border_color = Color3.fromRGB(40, 44, 40),
border_light_color = Color3.fromRGB(60, 65, 60),
accent_color = Color3.fromRGB(75, 255, 125),
accent_gradient_1 = Color3.fromRGB(75, 255, 125),
accent_gradient_2 = Color3.fromRGB(45, 210, 95),
text_white_color = Color3.fromRGB(245, 255, 245),
text_dark_color = Color3.fromRGB(150, 160, 150),
tooltip_background = Color3.fromRGB(10, 12, 10),
notification_info = Color3.fromRGB(70, 190, 255),
notification_success = Color3.fromRGB(75, 255, 125),
notification_warning = Color3.fromRGB(255, 210, 70),
notification_error = Color3.fromRGB(255, 70, 70)
}
...
["Dark Night"] = {
main_background = Color3.fromRGB(14, 14, 18),
sidebar_background = Color3.fromRGB(18, 18, 22),
section_background = Color3.fromRGB(22, 22, 26),
element_background = Color3.fromRGB(28, 28, 32),
element_hover_background = Color3.fromRGB(35, 35, 40),
border_color = Color3.fromRGB(44, 44, 50),
border_light_color = Color3.fromRGB(65, 65, 75),
accent_color = Color3.fromRGB(110, 140, 255),
accent_gradient_1 = Color3.fromRGB(110, 140, 255),
accent_gradient_2 = Color3.fromRGB(80, 100, 210),
text_white_color = Color3.fromRGB(245, 245, 255),
text_dark_color = Color3.fromRGB(150, 150, 160)
},
["Blood Red"] = {
main_background = Color3.fromRGB(18, 12, 12),
sidebar_background = Color3.fromRGB(22, 16, 16),
section_background = Color3.fromRGB(26, 20, 20),
element_background = Color3.fromRGB(32, 26, 26),
element_hover_background = Color3.fromRGB(40, 32, 32),
border_color = Color3.fromRGB(50, 40, 40),
border_light_color = Color3.fromRGB(75, 60, 60),
accent_color = Color3.fromRGB(255, 75, 75),
accent_gradient_1 = Color3.fromRGB(255, 75, 75),
accent_gradient_2 = Color3.fromRGB(210, 45, 45),
text_white_color = Color3.fromRGB(255, 245, 245),
text_dark_color = Color3.fromRGB(160, 150, 150)
}
}
...
tooltip_frame.Size = UDim2.new(0, 0, 0, 26)
...
Blur_Image.ImageTransparency = Transparency or 0.85
...
local function Create_DropShadow(Parent, Radius)
...
local Text_Bounds = text_service:GetTextSize(Text_String, 12, main_font, Vector2.new(500, 26))
tooltip_frame.Size = UDim2.new(0, Text_Bounds.X + 16, 0, 26)
...
Notification_Frame.Size = UDim2.new(1, 0, 0, 65)
...
Create_DropShadow(Notification_Frame, UDim.new(0, 6))
...
Apply_Acrylic_Effect(Notification_Frame, 0.85, UDim.new(0, 6))

local Line_Frame = Instance.new("Frame")
Line_Frame.Size = UDim2.new(0, 3, 1, -12)
Line_Frame.Position = UDim2.new(0, 8, 0, 6)
...
Text_Label.Position = UDim2.new(0, 20, 0, 28)
...
Apply_Acrylic_Effect(Main_Background, 0.85, UDim.new(0, 6))
Create_DropShadow(Main_Background, UDim.new(0, 6))

local Top_Bar = Instance.new("Frame")
Top_Bar.Size = UDim2.new(1, 0, 0, 40)
Set_Color(Top_Bar, "BackgroundColor3", "sidebar_background")
Top_Bar.BackgroundTransparency = 0.15
...
Top_Hider.BackgroundTransparency = 0.15
...
Title_Label.Position = UDim2.new(0, 16, 0, 2)
Title_Label.BackgroundTransparency = 1
...
Sidebar_Frame.Size = UDim2.new(0, 160, 1, -41)
Sidebar_Frame.Position = UDim2.new(0, 0, 0, 41)
Set_Color(Sidebar_Frame, "BackgroundColor3", "sidebar_background")
Sidebar_Frame.BackgroundTransparency = 0.15
...
Sidebar_Hider_Right.BackgroundTransparency = 0.15
...
Sidebar_Hider_Top.BackgroundTransparency = 0.15
...
Tab_Scrolling_Frame.Size = UDim2.new(1, -12, 1, -12)
Tab_Scrolling_Frame.Position = UDim2.new(0, 6, 0, 6)
...
Content_Area_Frame.Size = UDim2.new(1, -161, 1, -41)
Content_Area_Frame.Position = UDim2.new(0, 161, 0, 41)
...
function Window_Context:Tab_Create(Tab_Name, Icon_Id, Is_Bottom)
    ...
    if Is_Bottom then
        ...
        Tab_Button.Size = UDim2.new(1, -12, 0, 44)
        Tab_Button.Position = UDim2.new(0, 6, 1, -50)
        Tab_Scrolling_Frame.Size = UDim2.new(1, -12, 1, -60)
        
        local Tab_Icon = Instance.new("ImageLabel")
        Tab_Icon.Size = UDim2.new(0, 28, 0, 28)
        Tab_Icon.Position = UDim2.new(0, 10, 0.5, -14)
        ...
        Tab_Label.Position = UDim2.new(0, 46, 0, 0)
    ...
    function Tab_Data:Activate()
        ...
        Animate_Element(Tab_Button, {BackgroundTransparency = 0.1}, 0.3)
    ...
    local function Element_Injector(Target_Container)
        ...
        function Elements:Toggle_Create(Name, Flag, Default, Tooltip, Callback)
            ...
            Toggle_Label.Size = UDim2.new(1, -30, 1, 0)
            Toggle_Label.Position = UDim2.new(0, 26, 0, 0)
        ...
        function Elements:Slider_Create(Name, Flag, Min, Max, Default, Step, Tooltip, Callback)
            ...
            Value_Text_Box.Size = UDim2.new(0, 40, 0, 16)
            ...
            Slider_Background.BackgroundTransparency = 0.1
            ...
            Slider_Knob.Size = UDim2.new(0, 12, 0, 12)
        ...
        function Elements:RangeSlider_Create(Name, Flag, Min, Max, Default_Min, Default_Max, Step, Tooltip, Callback)
            ...
            Range_Slider_Frame.Size = UDim2.new(1, 0, 0, 40)
            ...
            Range_Slider_Label.Size = UDim2.new(1, -90, 0, 16)
            ...
            Range_Slider_Label.TextSize = 13
            ...
            Value_Label.Size = UDim2.new(0, 90, 0, 16)
            Value_Label.Position = UDim2.new(1, -92, 0, 0)
            ...
            Range_Slider_Background.BackgroundTransparency = 0.1
            ...
            Min_Range_Knob.Size = UDim2.new(0, 12, 0, 12)
            ...
            Max_Range_Knob.Size = UDim2.new(0, 12, 0, 12)
        ...
        function Elements:Textbox_Create(Name, Flag, Default, Tooltip, Callback)
            ...
            Textbox_Input_Background.Size = UDim2.new(0, 120, 0, 26)
            Textbox_Input_Background.Position = UDim2.new(1, -122, 0.5, -13)
            Set_Color(Textbox_Input_Background, "BackgroundColor3", "element_background")
            Textbox_Input_Background.BackgroundTransparency = 0.1
        ...
        function Elements:Keybind_Create(Name, Flag, Default, Tooltip, Callback)
            ...
            Library_Api.Flags[Flag.."_Mode"] = Library_Api.Flags[Flag.."_Mode"] or "Toggle"
            Library_Api.Flags[Flag.."_Active"] = false
            local Is_Listening = false

            local Modes = {"Toggle", "Hold", "Always"}

            local Keybind_Frame = Instance.new("Frame")
            Keybind_Frame.Size = UDim2.new(1, 0, 0, 32)
            ...
            Keybind_Button.Size = UDim2.new(0, 100, 0, 24)
            Keybind_Button.Position = UDim2.new(1, -104, 0.5, -12)
            Set_Color(Keybind_Button, "BackgroundColor3", "element_background")
            Keybind_Button.BackgroundTransparency = 0.1
            
            local function Update_Keybind_Text()
                local KeyName = Library_Api.Flags[Flag] == Enum.KeyCode.Unknown and "None" or Library_Api.Flags[Flag].Name
                Keybind_Button.Text = "[" .. KeyName .. "] | " .. Library_Api.Flags[Flag.."_Mode"]
            end
            Update_Keybind_Text()

            Set_Color(Keybind_Button, "TextColor3", "text_dark_color")
            Keybind_Button.TextSize = 12
            ...
            Keybind_Button.InputBegan:Connect(function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                    Is_Listening = true
                    Keybind_Button.Text = "[ ... ] | " .. Library_Api.Flags[Flag.."_Mode"]
                ...
                elseif Input.UserInputType == Enum.UserInputType.MouseButton2 and not Is_Listening then
                    local Current_Index = table.find(Modes, Library_Api.Flags[Flag.."_Mode"]) or 1
                    local Next_Index = (Current_Index % #Modes) + 1
                    Library_Api.Flags[Flag.."_Mode"] = Modes[Next_Index]
                    
                    if Library_Api.Flags[Flag.."_Mode"] == "Always" then
                        Library_Api.Flags[Flag.."_Active"] = true
                        if Callback then task.spawn(Callback, true) end
                    elseif Library_Api.Flags[Flag.."_Mode"] == "Hold" then
                        Library_Api.Flags[Flag.."_Active"] = false
            ...
            user_input_service.InputBegan:Connect(function(Input, Processed)
                ...
                elseif not Processed then
                    if Input.KeyCode == Library_Api.Flags[Flag] and Input.KeyCode ~= Enum.KeyCode.Unknown then
                        local Mode = Library_Api.Flags[Flag.."_Mode"]
                        if Mode == "Toggle" then
                            Library_Api.Flags[Flag.."_Active"] = not Library_Api.Flags[Flag.."_Active"]
                            if Callback then task.spawn(Callback, Library_Api.Flags[Flag.."_Active"]) end
            ...
            user_input_service.InputEnded:Connect(function(Input, Processed)
                if not Is_Listening and not Processed then
                    if Input.KeyCode == Library_Api.Flags[Flag] and Input.KeyCode ~= Enum.KeyCode.Unknown then
                        if Library_Api.Flags[Flag.."_Mode"] == "Hold" then
                            Library_Api.Flags[Flag.."_Active"] = false
                            if Callback then task.spawn(Callback, false) end
                        end
                    end
        ...
        function Elements:Dropdown_Create(Name, Flag, Options, Default, Tooltip, Callback)
            ...
            Dropdown_Main_Button.BackgroundTransparency = 0.1
            ...
            Dropdown_Option_List_Frame.Position = UDim2.new(0, 2, 0, 52)
            Set_Color(Dropdown_Option_List_Frame, "BackgroundColor3", "element_background")
            Dropdown_Option_List_Frame.BackgroundTransparency = 0.1
            ...
            local function Toggle_Dropdown_State()
                ...
                local Max_List_Height = math.min(#Current_Options * 26, 130)
                ...
                Animate_Element(Dropdown_Frame, {Size = UDim2.new(1, 0, 0, 50 + Target_List_Height + (Is_Dropdown_Open and 4 or 0))}, 0.3)
            end
            ...
            function Dropdown_Api:Refresh(New_Options)
                ...
                for _, Option in ipairs(Current_Options) do
                    ...
                    Option_Button.MouseEnter:Connect(function() 
                        Animate_Element(Option_Button, {BackgroundTransparency = 0.1}, 0.25)
                ...
                Dropdown_Option_List_Frame.CanvasSize = UDim2.new(0, 0, 0, #Current_Options * 26)
            end
        ...
        function Elements:MultiDropdown_Create(Name, Flag, Options, Default, Tooltip, Callback)
            Library_Api.Flags[Flag] = type(Library_Api.Flags[Flag]) == "table" and Library_Api.Flags[Flag] or (Default or {})
            local Is_Dropdown_Open = false
            local Current_Options = Options
            local Dropdown_Api = {}
            ...
            Selected_Option_Label.Position = UDim2.new(0, 8, 0, 0)
            Selected_Option_Label.BackgroundTransparency = 1
            Selected_Option_Label.Text = #Library_Api.Flags[Flag] > 0 and table.concat(Library_Api.Flags[Flag], ", ") or "None"
            Selected_Option_Label.ClipsDescendants = true
            Set_Color(Selected_Option_Label, "TextColor3", "text_dark_color")
            Selected_Option_Label.TextSize = 12
            Selected_Option_Label.Font = main_font
            Selected_Option_Label.TextXAlignment = Enum.TextXAlignment.Left
            ...
            function Dropdown_Api:Refresh(New_Options)
                ...
                for _, Option in ipairs(Current_Options) do
                    ...
                    local Is_Selected = table.find(Library_Api.Flags[Flag], Option) ~= nil

                    local Checkbox_Frame = Instance.new("Frame")
                    Checkbox_Frame.Size = UDim2.new(0, 14, 0, 14)
                    Checkbox_Frame.Position = UDim2.new(0, 6, 0.5, -7)
                    Set_Color(Checkbox_Frame, "BackgroundColor3", Is_Selected and "accent_color" or "element_background")
                    Checkbox_Frame.BackgroundTransparency = 0.1
                    Checkbox_Frame.Parent = Option_Button
                    ...
                    local Checkbox_Stroke = Instance.new("UIStroke")
                    Set_Color(Checkbox_Stroke, "Color", Is_Selected and "accent_color" or "border_color")
                    Checkbox_Stroke.Parent = Checkbox_Frame

                    local Option_Label = Instance.new("TextLabel")
                    Option_Label.Size = UDim2.new(1, -30, 1, 0)
                    Option_Label.Position = UDim2.new(0, 26, 0, 0)
                    Option_Label.BackgroundTransparency = 1
                    Option_Label.Text = Option
                    Set_Color(Option_Label, "TextColor3", Is_Selected and "text_white_color" or "text_dark_color")
                    Option_Label.TextSize = 12
                    Option_Label.Font = main_font
                    Option_Label.TextXAlignment = Enum.TextXAlignment.Left
                    Option_Label.Parent = Option_Button
                    ...
                    Option_Button.MouseButton1Click:Connect(function()
                        ...
                        if Idx then
                            ...
                            Animate_Element(Checkbox_Frame, {BackgroundColor3 = Colors_Table.element_background}, 0.3)
                            Animate_Element(Checkbox_Stroke, {Color = Colors_Table.border_color}, 0.3)
                            Animate_Element(Option_Label, {TextColor3 = Colors_Table.text_dark_color}, 0.3)
                        else
                            table.insert(Library_Api.Flags[Flag], Option)
                            Animate_Element(Checkbox_Frame, {BackgroundColor3 = Colors_Table.accent_color}, 0.3)
                            Animate_Element(Checkbox_Stroke, {Color = Colors_Table.accent_color}, 0.3)
                            Animate_Element(Option_Label, {TextColor3 = Colors_Table.text_white_color}, 0.3)
                        end
                        Selected_Option_Label.Text = #Library_Api.Flags[Flag] > 0 and table.concat(Library_Api.Flags[Flag], ", ") or "None"
                        if Callback then task.spawn(Callback, Library_Api.Flags[Flag]) end
                    end)
        ...
        function Elements:ColorPicker_Create(Name, Flag, Default, Tooltip, Callback)
            ...
            Color_Picker_Label.TextSize = 13
            ...
            Color_Preview_Button.Size = UDim2.new(0, 26, 0, 16)
            Color_Preview_Button.Position = UDim2.new(1, -30, 0, 4)
            ...
            Expanded_Picker_Frame.Position = UDim2.new(0, 2, 0, 30)
            Set_Color(Expanded_Picker_Frame, "BackgroundColor3", "element_background")
            Expanded_Picker_Frame.BackgroundTransparency = 0.1
            ...
            local function Process_Hue_Input(Input)
                ...
                if Saturation < 0.05 and Value > 0.95 then
                    Saturation = 1
                end
                Update_Color_Picker_State()
            end
        ...
        function Elements:Button_Create(Name, Tooltip, Callback)
            ...
            Button_Frame.Size = UDim2.new(1, 0, 0, 34)
        ...
        function Elements:SubButton_Create(Name, Tooltip, Callback)
            ...
            Sub_Button_Frame.Size = UDim2.new(1, 0, 0, 24)
        ...
        function Elements:Module_Create(Name, Flag, Description_Text, Default, Tooltip, Callback)
            ...
            Module_Frame.Size = UDim2.new(1, 0, 0, 50)
            ...
            Module_Checkbox_Frame.Size = UDim2.new(0, 18, 0, 18)
            Module_Checkbox_Frame.Position = UDim2.new(0, 14, 0.5, -9)
            Set_Color(Module_Checkbox_Frame, "BackgroundColor3", Library_Api.Flags[Flag] and "accent_color" or "section_background")
            Module_Checkbox_Frame.BackgroundTransparency = 0.1
            ...
            Module_Label.Size = UDim2.new(1, -45, 0, 18)
            Module_Label.Position = UDim2.new(0, 42, 0, 6)
            ...
            Module_Description_Label.Position = UDim2.new(0, 42, 0, 24)
            ...
            Module_Description_Label.TextSize = 12
            ...
            Module_Arrow_Icon.Position = UDim2.new(1, -24, 0, 17)
            ...
            Module_Content_Frame.Position = UDim2.new(0, 12, 0, 52)
            ...
            local function Synchronize_Module_Size()
                if Library_Api.Flags[Flag] then
                    Animate_Element(Module_Frame, {Size = UDim2.new(1, 0, 0, 50 + Module_Content_Layout.AbsoluteContentSize.Y + 8)}, 0.3)
                    Animate_Element(Module_Arrow_Icon, {Rotation = 180, ImageColor3 = Colors_Table.accent_color}, 0.3)
                else
                    Animate_Element(Module_Frame, {Size = UDim2.new(1, 0, 0, 50)}, 0.3)
    ...
    function Section_Api:Section_Create(Column_Side, Section_Title)
        ...
        Section_Background_Frame.BackgroundTransparency = 0.1
        ...
        Section_Content_Frame.Size = UDim2.new(1, -16, 1, -40)
        Section_Content_Frame.Position = UDim2.new(0, 8, 0, 36)
        ...
        run_service.RenderStepped:Connect(function()
            Section_Background_Frame.Size = UDim2.new(1, 0, 0, Section_Content_Layout.AbsoluteContentSize.Y + 48)
        end)
...
Menu_Section:Keybind_Create("Menu Toggle Bind", "Menu_Toggle_Key", Enum.KeyCode.Delete, "Right click to edit bind modes", function() end)
