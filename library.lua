...
local Nixware_Library_Sharp = {}

local Cool_Accent_Color = Color3.fromRGB(65, 115, 225)
local Cool_Main_Background = Color3.fromRGB(15, 15, 15)
local Cool_Sidebar_Color = Color3.fromRGB(15, 15, 15)
local Cool_Section_Color = Color3.fromRGB(15, 15, 15)
local Cool_Border_Color = Color3.fromRGB(45, 45, 45)
local Cool_Element_Background = Color3.fromRGB(25, 25, 25)
local Cool_Text_White = Color3.fromRGB(215, 215, 215)
...
local function Cool_Create_Tween(Target_Instance, Tween_Properties, Duration_Time)
    local Tween_Info_Data = TweenInfo.new(Duration_Time or 0.15, Enum.EasingStyle.Linear)
    local Created_Tween = Tween_Service:Create(Target_Instance, Tween_Info_Data, Tween_Properties)
    Created_Tween:Play()
    return Created_Tween
end

function Nixware_Library_Sharp:Cool_Window_Create(Window_Name_Text)
    local Cool_Screen_Gui = Instance.new("ScreenGui")
    Cool_Screen_Gui.Name = "Nixware_Sharp_UI"
    ...
    Cool_Top_Header.Size = UDim2.new(1, 0, 0, 24)
    Cool_Top_Header.BackgroundColor3 = Cool_Main_Background
    ...
    Cool_Top_Stroke.BackgroundColor3 = Cool_Border_Color
    ...
    Cool_Sidebar_Area.Size = UDim2.new(0, 130, 1, -25)
    Cool_Sidebar_Area.Position = UDim2.new(0, 0, 0, 25)
    ...
    Cool_Sidebar_Stroke.BackgroundColor3 = Cool_Border_Color
    ...
    Cool_Tab_List_Layout.Padding = UDim.new(0, 0)
    ...
    Cool_Content_Area.Size = UDim2.new(1, -131, 1, -25)
    Cool_Content_Area.Position = UDim2.new(0, 131, 0, 25)
    ...
    function Cool_Window_Methods:Cool_Tab_Create(Tab_Name_String)
        ...
        Cool_Tab_Button.TextXAlignment = Enum.TextXAlignment.Left
        Cool_Tab_Button.AutoButtonColor = false
        Cool_Tab_Button.Parent = Cool_Sidebar_Area

        local Cool_Tab_Highlight = Instance.new("Frame")
        Cool_Tab_Highlight.Size = UDim2.new(0, 2, 1, 0)
        Cool_Tab_Highlight.BackgroundColor3 = Cool_Accent_Color
        Cool_Tab_Highlight.BorderSizePixel = 0
        Cool_Tab_Highlight.Visible = false
        Cool_Tab_Highlight.Parent = Cool_Tab_Button
        ...
        table.insert(Cool_Window_Methods.All_Registered_Buttons, {Btn = Cool_Tab_Button, Line = Cool_Tab_Highlight})
        ...
        if #Cool_Window_Methods.All_Registered_Tabs == 1 then
            ...
            Cool_Tab_Highlight.Visible = true
        ...
        Cool_Tab_Button.MouseButton1Click:Connect(function()
            ...
            for _, Obj in pairs(Cool_Window_Methods.All_Registered_Buttons) do
                Obj.Btn.TextColor3 = Cool_Text_Dark
        ...
        function Cool_Section_Methods:Cool_Section_Create(Section_Name_String)
            ...
            Cool_Section_Body.Size = UDim2.new(1, -30, 0, 20)
            ...
            Cool_Container_Layout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
                Cool_Section_Body.Size = UDim2.new(1, -30, 0, Cool_Container_Layout.AbsoluteContentSize.Y + 30)
            ...
            local function Cool_Inject_Elements(Target_Container_Frame)
                ...
                function Cool_Element_Methods:Cool_Toggle_Create(Toggle_Name, Default_State, Callback_Func)
                    ...
                    Cool_Toggle_Frame.Size = UDim2.new(1, -24, 0, 16)
                    Cool_Toggle_Frame.BackgroundTransparency = 1
                    Cool_Toggle_Frame.Text = ""
                    Cool_Toggle_Frame.AutoButtonColor = false
                    ...
                    Cool_Toggle_Label.Size = UDim2.new(1, -22, 1, 0)
                    Cool_Toggle_Label.Position = UDim2.new(0, 22, 0, 0)
                    ...
                    Cool_Toggle_Frame.MouseButton1Click:Connect(function()
                        ...
                        Cool_Create_Tween(Cool_Toggle_Box, {BackgroundColor3 = Cool_Toggle_State and Cool_Accent_Color or Cool_Element_Background}, 0.15)
                        Cool_Create_Tween(Cool_Toggle_Label, {TextColor3 = Cool_Toggle_State and Cool_Text_White or Cool_Text_Dark}, 0.15)
                ...
                function Cool_Element_Methods:Cool_Slider_Create(Slider_Name, Min_Val, Max_Val, Default_Val, Callback_Func)
                    ...
                    Cool_Slider_Frame.Size = UDim2.new(1, -24, 0, 32)
                    ...
                    Cool_Slider_Bg.Position = UDim2.new(0, 0, 0, 20)
                ...
                function Cool_Element_Methods:Cool_Dropdown_Create(Dropdown_Name, Options_Table, Default_Option, Callback_Func)
                    ...
                    Cool_Dropdown_Main_Btn.Position = UDim2.new(0, 0, 0, 20)
                    ...
                    Cool_Dropdown_List_Frame.Position = UDim2.new(0, 0, 0, 43)
                    ...
                    local function Toggle_Dropdown()
                        ...
                        if Cool_Dropdown_State then
                            local Target_Size = 43 + (#Options_Table * 20)
                            Cool_Dropdown_Root.Size = UDim2.new(1, -24, 0, Target_Size)
                            Cool_Dropdown_List_Frame.Size = UDim2.new(1, 0, 0, #Options_Table * 20)
                            Cool_Dropdown_Icon.Text = "-"
                            Cool_Dropdown_Main_Stroke.Color = Cool_Accent_Color
                        else
                            Cool_Dropdown_Root.Size = UDim2.new(1, -24, 0, 42)
                            Cool_Dropdown_List_Frame.Size = UDim2.new(1, 0, 0, 0)
                            Cool_Dropdown_Icon.Text = "+"
                ...
                function Cool_Element_Methods:Cool_Module_Create(Module_Name, Module_Desc, Default_State, Callback_Func)
                    ...
                    Cool_Module_Root.Size = UDim2.new(1, -24, 0, 34)
                    ...
                    Cool_Module_Header.Size = UDim2.new(1, 0, 0, 34)
                    Cool_Module_Header.BackgroundColor3 = Cool_Element_Background
                    Cool_Module_Header.BorderSizePixel = 0
                    ...
                    Cool_Module_Root_Stroke.Parent = Cool_Module_Header

                    local Cool_Module_Checkbox = Instance.new("Frame")
                    Cool_Module_Checkbox.Size = UDim2.new(0, 12, 0, 12)
                    Cool_Module_Checkbox.Position = UDim2.new(0, 10, 0.5, -6)
                    ...
                    Cool_Module_Title.Size = UDim2.new(1, -32, 0, 16)
                    Cool_Module_Title.Position = UDim2.new(0, 32, 0, 3)
                    ...
                    Cool_Module_Desc_Label.Size = UDim2.new(1, -32, 0, 12)
                    Cool_Module_Desc_Label.Position = UDim2.new(0, 32, 0, 18)
                    ...
                    Cool_Module_Content.Position = UDim2.new(0, 0, 0, 36)
                    ...
                    local function Cool_Update_Module_Size()
                        if Cool_Module_State then
                            local Target_Y = 36 + Cool_Module_Layout.AbsoluteContentSize.Y
                            Cool_Module_Root.Size = UDim2.new(1, -24, 0, Target_Y)
                        else
                            Cool_Module_Root.Size = UDim2.new(1, -24, 0, 34)
                        end
                    end
                    ...
                    Cool_Module_Header.MouseButton1Click:Connect(function()
                        ...
                        Cool_Create_Tween(Cool_Module_Checkbox, {BackgroundColor3 = Cool_Module_State and Cool_Accent_Color or Cool_Element_Background}, 0.15)
                        Cool_Create_Tween(Cool_Module_Title, {TextColor3 = Cool_Module_State and Cool_Text_White or Cool_Text_Dark}, 0.15)
                        Cool_Create_Tween(Cool_Module_Root_Stroke, {Color = Cool_Module_State and Cool_Accent_Color or Cool_Border_Color}, 0.15)
                        Cool_Update_Module_Size()
                        Callback_Func(Cool_Module_State)
                    end)
                    
                    if Cool_Module_State then
                        Cool_Module_Root.Size = UDim2.new(1, -24, 0, 36 + Cool_Module_Layout.AbsoluteContentSize.Y)
                    end
