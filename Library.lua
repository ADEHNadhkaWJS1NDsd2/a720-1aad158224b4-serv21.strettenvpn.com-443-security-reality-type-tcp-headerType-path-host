...
local function BuildRuntime()
    ...
    local RifleBase64Data = ""
    ...
    local function ResolveRifleAsset()
        ...
        local FileName = Library.Folders.Assets .. "/AtramentaAK47V1.png"
        local Exists = type(isfile) == "function" and isfile(FileName)
        if not Exists then
    ...
    for _, Definition in ipairs(SidebarDefinitions) do
        ...
        local IconObject = Icon(Button, IconName, IconName == "Rifle" and UDim2.fromOffset(24, 24) or UDim2.fromOffset(20, 20), UDim2.fromScale(0.5, 0.5), MutedText, 7)
    ...
    local function ApiEnsureSidebarPage(Name)
        ...
        local IconObject = Icon(Button, ApiState.PageIcons[Name] or "Gear", Name == "Combat" and UDim2.fromOffset(22, 22) or UDim2.fromOffset(17, 17), UDim2.new(0.5, 0, 0, 17), MutedText, 7)
        local Label = Create("TextLabel", {
            Parent = Button,
