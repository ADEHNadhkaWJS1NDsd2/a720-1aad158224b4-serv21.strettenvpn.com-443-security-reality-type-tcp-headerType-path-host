...
EnableToggle:AddKeybind("None", "Toggle")
EnableToggle:SetRisk()

AutoParrySection:Divider("Timing")
AutoParrySection:Slider("Base TTI Threshold", 0.15, 0.01, 0.1, 0.5, "s", function(Value)
	TTIThreshold = Value
end)

local InfoSection = CombatTab:Section("Guide", "Right", "how it works")
InfoSection:Label("Toggle auto parry with keybind.")
InfoSection:Divider("Tips")
InfoSection:Info("Lower TTI parries later, higher parries earlier.")
InfoSection:Divider("Status")
InfoSection:Label(function() return "Auto parry: " .. (AutoParryEnabled and "ON" or "off") end)
...
ParrySection:Divider("Randomization")
...
SpamSection:Divider("Tuning")
SpamSection:Slider("Spam Rate", 200, 25, 200, 1000, "/s", function(Value) ConfigState.SpamRate = Value end)
...
VisMainSection:Divider("Range visualiser")
...
VisMainSection:Divider("Ability ESP")
...
VisAvatarSection:Divider("Nightfall Wings")
local NightfallWingsToggle = VisAvatarSection:Toggle("Angel Wings", false, function(Value)
    SetNightfallWingsEnabled(Value)
end)
NightfallWingsToggle:AddColorpicker("Wings Color", ConfigState.NightfallWingsColor, function(ColorValue)
    SetNightfallWingsColor(ColorValue)
end)
VisAvatarSection:Slider("Swing Speed", ConfigState.NightfallWingsSwingSpeed, 0.05, 0.1, 6, "x", function(Value)
    SetNightfallWingsSwingSpeed(Value)
end)

VisAvatarSection:Divider("Nightfall China Hat")
local NightfallChinaHatToggle = VisAvatarSection:Toggle("China Hat", false, function(Value)
    SetNightfallChinaHatEnabled(Value)
end)
NightfallChinaHatToggle:AddColorpicker("Hat Color", ConfigState.NightfallChinaHatColor, function(ColorValue)
    SetNightfallChinaHatColor(ColorValue)
end)
VisAvatarSection:Slider("Hat Scale", ConfigState.NightfallChinaHatScale, 0.05, 0.55, 1.65, "x", function(Value)
    SetNightfallChinaHatScale(Value)
end)
VisAvatarSection:Slider("Hat Height", ConfigState.NightfallChinaHatHeight, 0.05, -1.25, 2.5, "", function(Value)
    SetNightfallChinaHatHeight(Value)
end)
VisAvatarSection:Slider("Hat Radius", ConfigState.NightfallChinaHatRadius, 0.05, 0.75, 3.25, "", function(Value)
    SetNightfallChinaHatRadius(Value)
end)
VisAvatarSection:Slider("Cone Height", ConfigState.NightfallChinaHatConeHeight, 0.05, 0.7, 3.5, "", function(Value)
...
DetMainSection:Divider("Abilities")
